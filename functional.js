...
//Returs a URL-freindly version of a string.
...
// Exercise Problem
// function websiteUrls(elements) {
//   return elements.map( element => `https://example.com/${urlify(element)}`);
// }

// console.log(websiteUrls(states));
...
// Exercise Problems
// function checkDakotas(elements) {
//   return elements.filter(element => element.includes("Dakota"));
// }
// console.log(checkDakotas(states));
//
